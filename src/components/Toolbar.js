	...
	render() {
		...
		return (
			<Header style={this.props.collapsible ? { backgroundColor: 'rgba(0, 0, 0, 0)' } : { backgroundColor: '#424242' }}>
				...
				{
					this.props.navigation != undefined && !this.props.noBackButton ? this._renderBackButton( this.props.navigation ) : (<Left><CachedImage style={{ width: 30, height: 30 }} source={require('../../assets/img/logo.png')} /></Left>)
				}
				<Body style={{ flex: 2 }}>
